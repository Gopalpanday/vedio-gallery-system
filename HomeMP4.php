        ...
        <div class="container">
            ...
            <div class="player">
                ...
                <video id="playerPanel" width="620" height="420" controls autoplay>
                    <source src="Tuts//Home.mp4" type="video/mp4">
                </video>
            </div>
            ...
            <div class="playlist">
                <nav>
                    <ul id="playlistUL">
                        <script type="text/javascript" src="ActionScript/ChangeMP4SubjectAndChapterJS.js"></script>
                        <script type="text/javascript" src="ActionScript/ChangeMP4SearchContent.js"></script>
