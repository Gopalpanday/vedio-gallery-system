    ...
    <body id="bodyColor">
        <div class="container">
            ...
            <div class="playlist">
                <nav>
                    <ul id="playlistUL">
                        <script type="text/javascript" src="ActionScript/ChangeFlashSubjectAndChapterJS.js"></script>
                        <script type="text/javascript" src="ActionScript/ChangeFlashSearchContent.js"></script>
